...
public class LottoballDao {
	...
	public Integer getLottoballPeriods() {
		DBUtil util = new DBUtil();
		Connection connetion = util.openConnection();
		String sql = "SELECT dl.periods "
				+ "FROM lottolottery dl ORDER BY dl.periods desc";
	...
	public List<Lottoball> getLottoballListByQi(String qi) {
		...
		String sql = "SELECT ll.id,ll.redball_1,ll.redball_2,ll.redball_3,ll.redball_4,"
				...
				+ "FROM lottolottery ll WHERE ll.periods LIKE ? ;";
		PreparedStatement preparedStatement = null;
		ResultSet resulte = null;
		try {
			preparedStatement = connetion.prepareStatement(sql);
	...
	public List<Lottoball> getLottoballListByYiAll(String yiString) {
		List<Lottoball> lottoballList = null;
		DBUtil util = new DBUtil();
		Connection connetion = util.openConnection();
		String sql = "SELECT ll.id,ll.redball_1,ll.redball_2,ll.redball_3,ll.redball_4,"
