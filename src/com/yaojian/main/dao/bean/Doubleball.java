...
public class Doubleball extends LotteryBall {
	...
	public Doubleball(Integer redball_1, Integer redball_2, Integer redball_3,
	...
	public Doubleball getNormalRedball(Integer redball_1, Integer redball_2,
			Integer redball_3, Integer redball_4, Integer redball_5,
			Integer redball_6, Integer blueball_1, String periods,
			Date lotterydate) {
		return new Doubleball(redball_1, redball_2, redball_3, redball_4,
				redball_5, redball_6, null, null, null, blueball_1, null, null,
				periods, lotterydate);
	}
}
